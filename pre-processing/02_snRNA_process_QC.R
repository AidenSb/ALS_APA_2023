...
for (i in seq_along(sample_names)) {
  ...
  # Calculate percentages for mitochondrial, RPL and RPS genes
  ...
  # Filter out nuclei with high mitochondrial reads
  ...
  # Subset object based on minimum number of genes
